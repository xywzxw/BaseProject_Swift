...
extension PagerTitleView{
    ...
    @objc fileprivate func subBT_Click(_ bt: UIButton){
        ...
        delegate?.pageTitleDidSelected(self, index: BT_array.index(of: bt)!, title: (bt.titleLabel?.text)!)
...
extension PagerTitleView : UIScrollViewDelegate{
